...
import "github.com/TBD54566975/dap-go/maddr"
...
type MoneyAddressFilter[T any] func(maddr maddr.MoneyAddress) (*T, error)

// Filter applies the MoneyAddressFilter to each element in maddrs, and returns a slice of the MoneyAddresses that
// matched
func Filter[T any](maddrs []maddr.MoneyAddress, filter MoneyAddressFilter[T]) ([]T, error) {
	res := make([]T, 0)
